...
// Function Prototypes
void motor_control(int COM_USB_data);

int i=0,ii=0,pos=0,qq=0,txFlag=0;
char rx[100],tx[100];
...
void motor_control(int COM_USB_data)
{
    //int COM = 320;
    //int error;
    //phase_a = LATBbits.LATB3
    //phase_b = LATAbits.LATA0
    
    //RPA4Rbits.RPA4R = 0b0000;
    //TRISAbits.TRISA4 = 0;
    //LATAbits.LATA4 = 1;
    ...
    if (COM_USB_data < 325)
    {
        //error = (COM_USB_data-COM);
        OC1RS =  (50/100)*(PR2+1) ; //speed of PWM1 (faster)
        OC2RS =  (50/100) * (PR2+1) ; //speed of PWM2
        LATBbits.LATB3=1; //Direction of motor with PWM1. This motor is going forward
        LATAbits.LATA0=0; //Direction of motor with PWM2. This motor is going backwards   
    }
    else if(COM_USB_data > 315)
    {
        //error = COM-COM_USB_data;
        OC1RS =   (50/100)*(PR2+1);  //speed of PWM1
        OC2RS =   (50/100)*(PR2+1); //speed of PWM2 (faster)
        LATAbits.LATA0=1; //Direction of motor with PWM2. This motor is going forward. should be 0
        LATBbits.LATB3=0; //Direction of motor with PWM1. This motor is going backwards
    }
    else
    {
        OC1RS =  (50/100) * (PR2+1); //speed of PWM1
        OC2RS =  (50/100) * (PR2+1); //speed of PWM2
        LATAbits.LATA0=1; //Direction of motor with PWM2. This motor is going forward
        LATBbits.LATB3=1; //Direction of motor with PWM1. This motor is going forward
    }
