package com.example.yvesnazonii.android_camera;
...
public class MainActivity extends Activity implements TextureView.SurfaceTextureListener {
    ...
    private Paint paint11 = new Paint();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        greenControl = (SeekBar) findViewById(R.id.seek1);

        greenTextView = (TextView) findViewById(R.id.textView01);
        greenTextView.setText("Green level is (max is 255):");
        ...
        paint11.setColor(0xffff0000); // red
        paint11.setTextSize(24);
    }
    ...
    private void setMyControlListener() {
        greenControl.setOnSeekBarChangeListener(new OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                //greenValue = progress;
                green_number = (int) greenValue * progress ;
                //actual_number = (int) (green_number *(255/100));
                greenTextView.setText("The value is: " +green_number);
            }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surface, int width, int height) {
        ...
        parameters.setColorEffect(Camera.Parameters.EFFECT_NONE); // color camera
    ...
    public void onSurfaceTextureUpdated(SurfaceTexture surface) {
        ...
        if (c != null) {
            ...
            for (int i = 0; i < bmp.getWidth(); i++) {
                ...
                // brown is 250 in RGB; R:165 B:42 G:42
                // lots of green bad, little green good
                // 200 is a good value for the green number/threshold
                if (255-(green(pixels[i])) > green_number) {
                ...
                if (255-(green(pixels1[i])) > green_number) {
            ...
            canvas.drawText("COM1 = " + COM1, 10, 150, paint1);
